...
navLinks.forEach(link => {
    link.addEventListener('click', ()=> {
        ...
        document.querySelector('.logo').innerHTML = `<a href="#home">Kamlesh</a><i class="fa fa-bars menu" aria-hidden="true" onclick="handleNav()"></i>`;
...
function handleNav() {
    if (header.classList.contains('active')) {
        ...
        document.querySelector('.logo').innerHTML = `<a href="#home">Kamlesh</a><i class="fa fa-times menu" aria-hidden="true" onclick="handleNav()"></i>`;
    }
}
